<template>
  <div class="layout-topbar">
    ...
    <ul class="layout-topbar-menu">
      <li :class="getItemClass('settings')" @click="($event)=>{
    ...
    <li :class="getItemClass('profile','user-profile')" @click="($event)=>{
                    this.$emit('topbar-item-click', {
                        originalEvent: $event,
                        item: 'profile'
                    })}">
      ...
      <ul class="fadeInDown" v-if="visible('profile')">
        <li class="profile-detail">
          <div class="user-profile-info">
            ...
            <a href="#" class="profile-detail-icon" @click="logoutHandler"><i class="pi pi-sign-out"></i></a>
          </div>
        </li>
        <li>
          <a href="#"
